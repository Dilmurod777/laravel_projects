...
@section('content')
	<div class="movie-info border-b border-gray-800">
		<div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
			...
			<div class="md:ml-24">
				<h2 class="text-4xl font-semibold mt-4 md:mt-0">{{ $person['name'] }}</h2>
				<div class="flex flex-wrap items-center text-gray-400 text-sm mt-2">
					...
					<span
							class="ml-2">{{ $person['birthday'] }} ({{ $person['age'] }} years old) in {{ $person['place_of_birth'] }}</span>
				</div>
				...
				<div class="grid grid-col1sm:grid-cols-2 lg:grid-cols-5 gap-8">
